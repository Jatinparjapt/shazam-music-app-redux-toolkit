              ...
              <div className='flex py-1 lg:py-3 rounded-2xl place-content-between hover:bg-slate-400 w-full'>
                <div className="data flex items-center mx-3">
                  ...
                  <div>
                    ...
                    <button onClick={()=>(addToPlaylist(item.album.images[2].url ,item.name ,item.artists[0].name , item.preview_url ))} className='bg-black lg:hidden rounded-2xl p-1 text-white'> <MdOutlinePlaylistAdd/> Add To Playlist</button>
                  </div>
                </div>
                <div className='flex items-center cursor-pointer'>
                  <button onClick={()=>(addToPlaylist(item.album.images[2].url ,item.name ,item.artists[0].name , item.preview_url ))} className='bg-black hidden lg:block rounded-2xl p-1 mx-2 text-white'> <MdOutlinePlaylistAdd/> Add To Playlist</button>
